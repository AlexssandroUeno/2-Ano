...
public class GrafoComlistaEncadeadas // Declaração da classe Grafo
{
    ...
    public GrafoComlistaEncadeadas ( int numVertices )
    {
        this.adj = new Lista[ numVertices ];
        this.numVertices = numVertices;
        for( int i = 0; i < this.numVertices; i += 1 ) this.adj[i] = new Lista();
    }
