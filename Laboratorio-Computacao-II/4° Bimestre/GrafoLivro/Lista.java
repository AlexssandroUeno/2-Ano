public class Lista
{
  ...
  public Object retira ( Object chave ) throws Exception 
  {
      ...
      while ( aux.prox != null && !aux.prox.item.equals(chave) )
        aux = aux.prox;
      if( aux.prox == null ) return null; // Chave não encontrada
  ...
  public Object primeiro () { this.pos = primeiro; return proximo();}
  
  public Object proximo() 
  {
      this.pos = this.pos.prox;
      if( this.pos == null ) return null; else return this.pos.item;
  }
